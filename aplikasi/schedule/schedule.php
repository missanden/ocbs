...
if($_SESSION['s_position']=='admin'){$y = 14;}
  ...
  for ($x = 0; $x <= $y; $x++) {
	...
	master_mobil.no_polisi NOT IN ('B1390FJD','B1340FIB','B1892FIH') AND 
	...
	$q="SELECT * FROM master_mobil
	WHERE master_mobil.kepemilikan_mobil='Operasional' AND master_mobil.aktif_mobil IN ('aktif') AND master_mobil.no_polisi NOT IN ('B1390FJD','B1340FIB','B1892FIH') ORDER BY master_mobil.kepemilikan_mobil,master_mobil.no_polisi DESC";
